...
const translations = {
    tr: {
        ...
        'settings.tray_action_vol_up': 'Sesi Arttır (+10%)',
        'settings.tray_action_vol_down': 'Sesi Azalt (-10%)',
    ...
    en: {
        ...
        'settings.tray_action_vol_up': 'Volume Up (+10%)',
        'settings.tray_action_vol_down': 'Volume Down (-10%)',
